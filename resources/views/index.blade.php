<x-front-layout>
            ...
            <div class="row">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12 order-2">
                    <div class="inner-column">
                        ...
                        <div class="btn-box"><a href="#" class="theme-btn btn-style-three"><span class="btn-title">Make inquiry</span></a></div>
                    </div>
                </div>
    ...
    <section class="gallery-section style-two mb-40">
        <div class="gallery-carousel owl-carousel owl-theme">
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image">
                        <img src="{{ asset('storage/images/gallery/day3-cross-section.webp') }}" alt="">
                        <figcaption>Day 3 of the event</figcaption>
                    </figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/day3-cross-section.webp') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image"><img src="{{ asset('storage/images/gallery/day3-participants.webp') }}" alt=""></figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/day3-participants.webp') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image"><img src="{{ asset('storage/images/gallery/3.jpg') }}" alt=""></figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/3.jpg') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image"><img src="{{ asset('storage/images/gallery/4.jpg') }}" alt=""></figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/4.jpg') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image"><img src="{{ asset('storage/images/gallery/5.jpg') }}" alt=""></figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/5.jpg') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
            ...
            <div class="gallery-item">
                <div class="image-box">
                    <figure class="image"><img src="{{ asset('storage/images/gallery/6.jpg') }}" alt=""></figure>
                    <div class="overlay-box"><a href="{{ asset('storage/images/gallery/6.jpg') }}" class="lightbox-image" data-fancybox='gallery'><span class="icon fa fa-expand-arrows-alt"></span></a></div>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="outer-box clearfix">
            ...
            <div class="content-column">
                ...
                <div class="inner-column">
                    ...
                    <div class="btn-box"><a href="#" class="theme-btn btn-style-four"><span class="btn-title">Register Now</span></a></div>
                </div>
            </div>
        ...
        <div class="auto-container">
            ...
            <div class="row">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-1.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-2.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-4.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-3.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-5.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-6.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-7.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                            <h4 class="name"><a href="speakers-detail.html">Kenyetta Lesley</a></h4>
                            <span class="designation">Event Manager</span>
                ...
                <div class="speaker-block-three col-xl-3 col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                    <div class="inner-box">
                        <div class="image-box">
                            <figure class="image"><a href="speakers-detail.html"><img src="{{ asset('storage/images/resource/speaker-8.jpg') }}" alt=""></a></figure>
                        </div>
                        <div class="info-box">
                            <h4 class="name"><a href="speakers-detail.html">Shelly Verghese</a></h4>
                            <span class="designation">Event Manager</span>
                ...
                <div class="btns-box">
                    ...
                    <ul class="tab-buttons clearfix">
                        <li class="tab-btn active-btn" data-tab="#tab-1">
                            <span class="day">SUMCOURSE</span>
                            <span class="date">06</span>
                            <span class="month">Mar</span> 2023
                        </li>

                        <li class="tab-btn" data-tab="#tab-2">
                            <span class="day">OPENSTREETS</span>
                            <span class="date">22</span>
                            <span class="month">Apr</span> 2023
                        </li>

                        <li class="tab-btn" data-tab="#tab-3">
                            <span class="day">SUMCOURSE</span>
                            <span class="date">18</span>
                            <span class="month">May</span> 2023
                        </li>
                                ...
                                <div class="inner-box">
                                    <div class="inner">
                                        ...
                                        <div class="speaker-info">
                                            <figure class="thumb"><img src="{{ asset('storage/images/resource/thumb-1.jpg') }}" alt=""></figure>
                            ...
                            <div class="schedule-block col-lg-6 col-md-12 col-sm-12">
                                <div class="inner-box">
                                    <div class="inner">
                                        ...
                                        <div class="speaker-info">
                                            <figure class="thumb"><img src="{{ asset('storage/images/resource/thumb-2.jpg') }}" alt=""></figure>
                                            <h5 class="name">Ashli Scroggy</h5>
                                            <span class="designation">Founder & CEO</span>
                                        </div>
                                        <h4><a href="event-detail.html">Modern Marketing Summit Sydney 2018</a></h4>
            ...
            <div class="row">
                ...
                <div class="content-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="link-box">
                            <a href="#"><img src="{{ asset('storage/images/icons/app-store.png') }}" alt=""></a>
                            <a href="#"><img src="{{ asset('storage/images/icons/google-play.png') }}" alt=""></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="image-column col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="image-box">
                            <figure class="image wow fadeInRight"><img src="{{ asset('storage/images/resource/app-mockup.png') }}" alt=""></figure>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Call to action -->
    <section class="call-to-action" style="background-image: url(/storage/images/background/11.jpg);">
        <div class="auto-container">
            ...
            <div class="sponsors-outer">
                <div class="sponsors-carousel owl-carousel owl-theme">
                    ...
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-1.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-2.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-3.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-4.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-5.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-6.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-7.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-8.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-9.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-10.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-11.png') }}" alt=""></a></figure>
                    </div>

                    <!-- Client Block -->
                    <div class="client-block">
                        <figure class="image-box"><a href="#"><img src="{{ asset('storage/images/clients/2-12.png') }}" alt=""></a></figure>
                    </div>
                </div>
            </div>
        </div>
