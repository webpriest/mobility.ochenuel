<x-app-layout title="Edit OpenStreet">
    @push('styles')
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Edit OpenStreet</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-8">
                                <h4 class="card-title">Edit OpenStreet</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <form action="{{ route('manager.openstreet.update', $openstreet) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="mb-3">
                                                <label class="form-label" for="title">Title</label>
                                                <input type="text" name="title" class="form-control" id="title" value="{{ old('title', $openstreet) }}" placeholder="OpenStreet title">
                                                @error('title')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="sub_title" class="form-control" id="sub_title" value="{{ old('sub_title', $openstreet) }}" placeholder="Sub title (if any)">
                                                @error('sub_title')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content" class="form-control" id="classic-editor" placeholder="Main content">{{ old('content', $openstreet) }}</textarea>
                                                @error('content')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="">
                                                        ...
                                                        @if($openstreet->photo)
                                                        data-default-file="{{ $openstreet->photo() }}"
                                                    @endif
                                                        >
                                                        @error('photo')
                                                            <span class="error">{{ $message }}</span>
