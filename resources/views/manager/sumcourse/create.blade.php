<x-app-layout title="Add SUMCourse">
    @push('styles')
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">New SUMCourse</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-8">
                                <h4 class="card-title">New SUMCourse</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <livewire:main.sumcourse.add-sumcourse />
                                    </div>
                                </div>
                            </div>
                        </div>
