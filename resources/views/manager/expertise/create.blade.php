<x-app-layout title="Add Expertise">
    @push('styles')
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">New Expertise</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <form action="{{ route('manager.expertise.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-10">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="title">Title</label>
                                                        <input type="text" name="title" class="form-control" id="title" placeholder="Expertise title">
                                                        @error('title')
                                                ...
                                                <div class="col-md-2">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="icon" class="form-control" id="icon" value="icofont-">
                                                        @error('icon')
                                                            <span class="error">{{ $message }}</span>
                                                        @enderror
                                                    </div>
