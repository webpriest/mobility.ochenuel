<x-app-layout title="Edit Speaker">
    @push('styles')
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <form action="{{ route('manager.speaker.update', $speaker) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="title" class="form-control" id="title" placeholder="e.g Dr., Mr." value="{{ old('title', $speaker->title) }}">
                                                        @error('title')
                                                ...
                                                <div class="col-md-8">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="name" class="form-control" id="name" placeholder="name of speaker" value="{{ old('name', $speaker->name) }}">
                                                        @error('name')
                                                            <span class="error">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="role" class="form-control" id="role" placeholder="e.g Guest speaker" value="{{ old('role', $speaker->role) }}">
                                                        @error('role')
                                                            <span class="error">{{ $message }}</span>
                                                        @enderror
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="country_id" class="form-select select2" id="country_id">
                                                            ...
                                                            @foreach($countries as $country)
                                                                ...
                                                                {{ ($speaker->country_id === $country->id) ? 'selected' : '' }}>{{ $country->country }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('country_id')
                                                            <span class="error">{{ $message }}</span>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="bio" class="form-control" id="classic-editor" placeholder="bio here">{{ old('bio', $speaker->bio) }}</textarea>
                                                @error('bio')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    ...
                                                    @if($speaker->avatar)
                                                        data-default-file="{{ $speaker->avatar() }}"
                                                    @endif
                                                    >
                                                    @error('avatar')
                                                        <span class="error">{{ $message }}</span>
