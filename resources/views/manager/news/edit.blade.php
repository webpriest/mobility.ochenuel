                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Edit News</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-8">
                                <h4 class="card-title">Edit News Post</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <form action="{{ route('manager.news.update', $post) }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PATCH')
                                            <div class="mb-3">
                                                <label class="form-label" for="title">Title</label>
                                                <input type="text" name="title" class="form-control" id="title" placeholder="News post title" value="{{ old('title', $post->title) }}">
                                                @error('title')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="sub_title" class="form-control" id="sub_title" placeholder="Sub title (if any)" value="{{ old('sub_title', $post->sub_title) }}">
                                                @error('sub_title')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content" class="form-control" id="classic-editor" placeholder="Content here">{{ old('content', $post->content) }}</textarea>
                                                @error('content')
                                                    <span class="error">{{ $message }}</span>
                                                @enderror
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="news_date" class="form-control" id="news_date" placeholder="Date" autocomplete="off" value="{{ old('news_date', $post->news_date) }}">
                                                                @error('news_date')
                                                                    <span class="error">{{ $message }}</span>
                                                                @enderror
                                                            </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="author" class="form-control" id="author" placeholder="News author" value="{{ old('author', $post->author) }}">
                                                                @error('author')
                                                                    <span class="error">{{ $message }}</span>
                                                                @enderror
                                                            </div>
