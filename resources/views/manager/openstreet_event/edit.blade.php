<x-app-layout title="Edit OpenStreet Event">
    @push('styles')
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Update OpenStreet Event</a></li>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-8">
                                <h4 class="card-title">Edit {{ $openstreetevent->title }}</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mt-4">
                                        <livewire:main.openstreetevent.edit-openstreet-event :openstreetevent="$openstreetevent" />
                                    </div>
                                </div>
                            </div>
                        </div>
